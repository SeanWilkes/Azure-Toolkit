...
try {
    ...
    $env:SUBSCRIPTION_ID = "064aadfd-ffbe-475a-a4d1-09b5b6589dd2";
    $env:RESOURCE_GROUP = "LAB-RG";
    $env:TENANT_ID = "e737db3d-0a46-4b15-84b6-212694e0f81d";
    $env:LOCATION = "eastus2";
    $env:AUTH_TYPE = "token";
    $env:CORRELATION_ID = "0e1b3d43-86c3-4d69-aef9-359abf9256bf";
